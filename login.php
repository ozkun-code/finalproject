            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="bg-soft-primary">
                            <div class="row">
                                ...
                                <div class="col-5 align-self-end">
                                    <img src="http://localhost/FinalProject/assets/images/profile-img.png" alt=""
                                        class="img-fluid">
                                </div>
                            </div>
                        </div>
                        <div class="card-body pt-0">
                                ...
                                <a href="http://localhost/FinalProject">
                                    <div class="avatar-md profile-user-wid mb-4">
                                        <span class="avatar-title rounded-circle bg-light">
                                            <img src="http://localhost/FinalProject/assets/images/logo.png" alt=""
                            ...
                            <div class="p-2">
                                ...
                                <form class="form-horizontal" action="" method="POST" >
                                    <input type="hidden" >                                                                                                            <div class="form-group">
                                    <label for="useremail" class="form-label">Email: </label>
                                        <input name="useremail" type="email" id="email"
                                            class="form-control "
                                             id="useremail" placeholder="Enter username"
                    ...
                    <div class="mt-5 text-center">
                        <p>Don&#039;t have an account ? <a href="http://localhost/FinalProject/register"
                                class="font-weight-medium text-primary"> Sign Up here</a> </p>
