...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="./../assets/img/logoweb1__1_-removebg-preview.png">
    <!-- App css -->
            ...
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        ...
                        <a href="./../doctor/index.php" class="logo logo-light">
                            <span class="logo-lg">
                                <img src="./../assets/img/logoweb-removebg-preview.png" alt="" height="75">
                            </span>
                            <span class="logo-sm">
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item noti-icon waves-effect" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="./../assets/img/us.svg" class="rounded" alt="Header Language" height="20">
                        </button>
                        <div class="dropdown-menu dropdown-menu-end">

                            <!-- item-->
                            <a href="https://doctorly.themesbrand.website/index/en" class="dropdown-item notify-item language py-2" data-lang="en" title="English">
                                <img src="https://doctorly.themesbrand.website/assets/images/flags/us.svg" alt="user-image" class="me-2 rounded" height="20">
                                <span class="align-middle">English</span>
                            </a>

                            <!-- item-->
                            <a href="https://doctorly.themesbrand.website/index/sp" class="dropdown-item notify-item language" data-lang="sp" title="Spanish">
                                <img src="./../assets/img/spain.svg" alt="user-image" class="me-2 rounded" height="20">
                                <span class="align-middle">Española</span>
                            </a>

                            <!-- item-->
                            <a href="https://doctorly.themesbrand.website/index/gr" class="dropdown-item notify-item language" data-lang="gr" title="German">
                                <img src="https://doctorly.themesbrand.website/assets/images/flags/germany.svg" alt="user-image" class="me-2 rounded" height="20"> <span class="align-middle">Deutsche</span>
                            </a>

                            <!-- item-->
                            <a href="https://doctorly.themesbrand.website/index/it" class="dropdown-item notify-item language" data-lang="it" title="Italian">
                                <img src="https://doctorly.themesbrand.website/assets/images/flags/italy.svg" alt="user-image" class="me-2 rounded" height="20">
                                <span class="align-middle">Italiana</span>
                            </a>

                            <!-- item-->
                            <a href="https://doctorly.themesbrand.website/index/ru" class="dropdown-item notify-item language" data-lang="ru" title="Russian">
                                <img src="https://doctorly.themesbrand.website/assets/images/flags/russia.svg" alt="user-image" class="me-2 rounded" height="20">
                                <span class="align-middle">русский</span>
                            </a>

                            <!-- item-->
                            <a href="https://doctorly.themesbrand.website/index/ch" class="dropdown-item notify-item language" data-lang="ch" title="Chinese">
                                <img src="https://doctorly.themesbrand.website/assets/images/flags/china.svg" alt="user-image" class="me-2 rounded" height="20">
                                <span class="align-middle">中国人</span>
                            </a>

                            <!-- item-->
                            <a href="https://doctorly.themesbrand.website/index/fr" class="dropdown-item notify-item language" data-lang="fr" title="French">
                                <img src="https://doctorly.themesbrand.website/assets/images/flags/french.svg" alt="user-image" class="me-2 rounded" height="20">
                                <span class="align-middle">français</span>
                            </a>
                            <!-- item-->
                            <a href="https://doctorly.themesbrand.website/index/ae" class="dropdown-item notify-item language" data-lang="ae" title="Arabic">
                                <img src="https://doctorly.themesbrand.website/assets/images/flags/ae.svg" alt="user-image" class="me-2 rounded" height="18">
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-0" aria-labelledby="page-header-notifications-dropdown">
                            ...
                            <div data-simplebar class="notification-list-scroll overflow-auto" style="max-height: 230px;">
                                <a href="/notification/3533" class="text-reset notification-item bg-light ">
                                    <div class="media">
                                        <img src=" https://doctorly.themesbrand.website/storage/images/users/1698418992.PNG" class="mr-4 rounded-circle avatar-xs" alt="user-pic">
                                ...
                                <a href="/notification/3531" class="text-reset notification-item bg-light ">
                                    <div class="media">
                                        <img src=" https://doctorly.themesbrand.website/storage/images/users/1698418992.PNG" class="mr-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="media-body">
                                            <h6 class="mt-0 mb-1">
                                                Doctor Doctorly</h6>
                                            <div class="font-size-12 text-muted">
                                ...
                                <a href="/notification/3529" class="text-reset notification-item bg-light ">
                                    <div class="media">
                                        <img src=" https://doctorly.themesbrand.website/storage/images/users/1698418992.PNG" class="mr-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="media-body">
                                            <h6 class="mt-0 mb-1">
                                ...
                                <a href="/notification/3527" class="text-reset notification-item bg-light ">
                                    <div class="media">
                                        <img src=" https://doctorly.themesbrand.website/storage/images/users/1698418992.PNG" class="mr-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="media-body">
                                            <h6 class="mt-0 mb-1">
                                ...
                                <a href="/notification/3523" class="text-reset notification-item bg-light ">
                                    <div class="media">
                                        <img src=" https://doctorly.themesbrand.website/storage/images/users/1698418992.PNG" class="mr-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="media-body">
                                            <h6 class="mt-0 mb-1">
                                ...
                                <a href="/notification/3521" class="text-reset notification-item bg-light ">
                                    <div class="media">
                                        <img src=" https://doctorly.themesbrand.website/storage/images/users/1698418992.PNG" class="mr-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="media-body">
                                            <h6 class="mt-0 mb-1">
                                ...
                                <a href="/notification/3519" class="text-reset notification-item bg-light ">
                                    <div class="media">
                                        <img src=" https://doctorly.themesbrand.website/storage/images/users/1698418992.PNG" class="mr-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="media-body">
                                            <h6 class="mt-0 mb-1">
                                ...
                                <a href="/notification/3517" class="text-reset notification-item bg-light ">
                                    <div class="media">
                                        <img src=" https://doctorly.themesbrand.website/storage/images/users/1698418992.PNG" class="mr-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="media-body">
                                            <h6 class="mt-0 mb-1">
                                ...
                                <a href="/notification/3515" class="text-reset notification-item bg-light ">
                                    <div class="media">
                                        <img src=" https://doctorly.themesbrand.website/storage/images/users/1698418992.PNG" class="mr-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="media-body">
                                            <h6 class="mt-0 mb-1">
                                ...
                                <a href="/notification/3513" class="text-reset notification-item bg-light ">
                                    <div class="media">
                                        <img src=" https://doctorly.themesbrand.website/storage/images/users/1698418992.PNG" class="mr-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="media-body">
                                            <h6 class="mt-0 mb-1">
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="rounded-circle header-profile-user" src=" https://doctorly.themesbrand.website/storage/images/users/1698418992.PNG" alt="Avatar">
                            <span class="d-none d-xl-inline-block ml-1">Doctor</span>
                            <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                        </button>
                        <div class="dropdown-menu dropdown-menu-right">
                            <!-- item-->
                            <a class="dropdown-item" href="https://doctorly.themesbrand.website/profile-edit"><i class="bx bx-user font-size-16 align-middle mr-1"></i>
                                Change Profile</a>
                            <a class="dropdown-item" href="https://doctorly.themesbrand.website/payment-key"><i class="bx bx-key font-size-16 align-middle mr-1"></i>
                                Add Api Key</a>
                            <a class="dropdown-item" href="https://doctorly.themesbrand.website/app-setting"><i class="bx bx-cog font-size-16 align-middle mr-1"></i>
                                App Settings</a>
                            <a class="dropdown-item d-block" href="https://doctorly.themesbrand.website/change-password"><i class="bx bx-wrench font-size-16 align-middle mr-1"></i>
                                Change Password</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item text-danger" href="javascript:void();" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="bx bx-power-off font-size-16 align-middle mr-1 text-danger"></i>
                                Logout </a>
                            <form id="logout-form" action="./../logout.php" method="POST" style="display: none;">
                                <input type="hidden" name="_token" value="a7KNvFDGbrY46H6kn0fs8nPcH8Az0PRnh1tBmR3u">
                            </form>
                        </div>
                    </div>
                    <div class="dropdown d-inline-block">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="topnav-layout">
                                    ...
                                    <a href="https://doctorly.themesbrand.website/doctor/create" class="dropdown-item">Add New Doctor</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-layout" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="bx bx-user-circle mr-2"></i>Patients <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="topnav-layout">
                                    <a href="https://doctorly.themesbrand.website/patient" class="dropdown-item">List of Patients</a>
                                    <a href="https://doctorly.themesbrand.website/patient/create" class="dropdown-item">Add New Patient</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-layout" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="bx bx-user-circle mr-2"></i>Receptionist <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="topnav-layout">
                                    <a href="https://doctorly.themesbrand.website/receptionist" class="dropdown-item">List of Receptionist</a>
                                    <a href="https://doctorly.themesbrand.website/receptionist/create" class="dropdown-item">Add New Receptionist</a>
                                </div>
                            </li>
                            <li class="nav-item">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="pt-4">
                                                ...
                                                <div class="row mt-4">
                                                    <div class="col-6">
                                                        <a href="https://doctorly.themesbrand.website/receptionist" class="mb-0 font-weight-medium font-size-15">
                                                            <h5 class="mb-0">3
                                                            </h5>
                                                        </a>
                                    ...
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="media-body">
                                                ...
                                                <button class="btn  btn-primary  btn-sm mr-2 per-page-items  mb-md-1" data-page="10">10</button>
                                                <button class="btn  btn-info  btn-sm mr-2 per-page-items  mb-md-1" data-page="25">25</button>
                                                <button class="btn  btn-info  btn-sm mr-2 per-page-items  mb-md-1" data-page="50">50</button>
                                                <button class="btn  btn-info  btn-sm mr-2 per-page-items  mb-md-1" data-page="100">100</button>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="media">
                                                <div class="media-body">
                                                    ...
                                                    <a href="https://doctorly.themesbrand.website/today-appointment" class="mb-0 font-weight-medium font-size-24">
                                                        <h4 class="mb-0">0</h4>
                                                    </a>
                                                </div>
                                                <div class="mini-stat-icon avatar-sm rounded-circle bg-primary align-self-center">
                                        ...
                                        <div class="card-body">
                                            <div class="media">
                                                <div class="media-body">
                                                    ...
                                                    <a href="https://doctorly.themesbrand.website/upcoming-appointment" class="mb-0 font-weight-medium font-size-24">
                                                        <h4 class="mb-0">19
                                                        </h4>
                                                    </a>
                                                </div>
    ...
    <div class="right-bar">
        <div data-simplebar class="h-100">
            ...
            <div class="p-4">
                ...
                <div class="custom-control custom-switch mb-3">
                    <input type="checkbox" class="custom-control-input theme-choice" id="dark-mode-switch" data-bsStyle="https://doctorly.themesbrand.website/assets/css/bootstrap-dark.min.css" data-appStyle="https://doctorly.themesbrand.website/assets/css/app-dark.min.css" />
                ...
                <div class="custom-control custom-switch mb-5">
                    <input type="checkbox" class="custom-control-input theme-choice" id="rtl-mode-switch" data-appStyle="https://doctorly.themesbrand.website/assets/css/app-rtl.min.css" />
                    <label class="custom-control-label" for="rtl-mode-switch">RTL Mode</label>
                </div>
                <a href="javascript::void(0);" class="btn btn-primary btn-block mt-3" target="_blank"><i class="mdi mdi-cart mr-1"></i> Purchase Now</a>
            </div>
